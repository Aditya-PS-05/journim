...
const SearchHotel = () => {
  const [selectedOption, setSelectedOption] = useState("Hotel"); // Default to Hotel
  const [tripType, setTripType] = useState("Stay"); // Simplified for hotels
      ...
      <div className="min-h-[calc(100vh-80px)] flex items-center justify-center">
        <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 m-4 sm:m-10">
          ...
          >
                    ...
                    >
                      ...
                      <span
                        className={`text-white text-base sm:text-lg ${
                          selectedOption === item.label ? "opacity-100" : "opacity-70"
                        }`}
                      >
                        {item.label}
                      </span>
            ...
            {/* Trip Type Selection (Simplified for Hotels) */}
            <div className="flex flex-wrap gap-4 sm:gap-6 mb-6 sm:mb-8 mt-4">
              {["Single Stay", "Multiple Stays"].map((type) => (
                <button
                  key={type}
                ...
                >
                  ...
                  <span
                    className={tripType === type ? "text-white" : "text-white/70"}
                  >
                    {type}
                  </span>
                </button>
            ...
            <div className="w-full flex flex-col lg:flex-row justify-between gap-6 lg:gap-4">
                ...
                <div className="flex flex-col sm:flex-row bg-black/20 backdrop-blur-md rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border-2 border-white/70">
                  <div className="cursor-pointer w-full">
                    ...
                    <div className="text-white">
                      <div>
                        <span className="text-4xl sm:text-6xl font-light">1</span>
                        <span className="text-xl sm:text-2xl ml-2">Room 2 Adults</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full lg:w-[30%]">
                ...
                <div className="mt-4">
                  <label className="text-white/60 block mb-2">Price per Night</label>
                  <div className="flex gap-2">
                    <input
                      type="number"
                      placeholder="From"
                      className="w-full p-2 bg-black/20 border border-white/70 rounded-lg text-white placeholder-white/60 focus:outline-none"
                    />
                    <input
                      type="number"
                      placeholder="To"
                ...
                <div className="mt-4">
                  <label className="text-white/60 block mb-2">Star Category</label>
                  <div className="space-y-2">
                    {["3 Star", "4 Star", "5 Star", "Anything is Fine"].map(
                      (star, index) => (
                        <div key={index} className="flex items-center gap-2">
                          <div className="relative flex items-center">
                            <input
